...
void nms_debugDrawer::drawSphere(const btVector3& p, btScalar radius, const btVector3& color)
{
...
void nms_debugDrawer::setDebugMode(int debugMode)
{
   m_debugMode = debugMode;
}

int nms_debugDrawer::getDebugMode() const 
{
	return m_debugMode;
}   

void nms_debugDrawer::draw3dText(const btVector3& location,const char* textString)
{
   //glRasterPos3f(location.x(),  location.y(),  location.z());
   //BMF_DrawString(BMF_GetFont(BMF_kHelvetica10),textString);
}

void nms_debugDrawer::reportErrorWarning(const char* warningString)
{
